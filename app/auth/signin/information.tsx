            ...
            <div className="bg-[#1484CC] px-14 py-12 rounded-t-xl	">
                <div className="w-60">
                    <div className="flex items-center justify-center gap-3">
                        ...
                        <span className="text-xl font-medium text-white">Sign In</span>
                    </div>
                    <div className="mt-4 flex items-center text-center py-5 border-t-[1px] border-[#ffffff1a]">
                        <span className="items-center align-middle text-[13px] text-[#efefef] font-normal">Sign In Now And Meet The Awesome Friends Around The World.</span>
                    </div>
                    <DataForm type={true} />
                    <ServiceLogin />
                    <NohaveSignup type={true} />
                </div>
            </div>
            {/* Triangle shape */}
